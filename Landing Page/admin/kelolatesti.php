...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
          ...
          <table class="table table-bordered dataTable" id="tableUser" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
            <thead>
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 127px;">Name</th>
                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 127px;">Testimonials</th>
            ...
            if(mysqli_num_rows($query)>0){ ?>
                ...
                <tr role="row" class="odd">
                    ...
                    <td>
                        <a class="btn btn-danger" href="deletetesti.php?id=<?php echo $data['fullname']; ?>">Delete</a>
                    </td>
                </tr>
                <?php $no++; } ?>
            <?php } ?>
        ...
        <a class="btn btn-primary" href="tambahtesti.php">Add New Testimonials</a>
        </div>
        </div>
        </div>
        <!-- pembatas -->
